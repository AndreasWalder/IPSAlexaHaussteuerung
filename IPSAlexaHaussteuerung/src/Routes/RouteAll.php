...
final class RouteAll{
    ...
    private function resolveRendererForDomain(array $domain){$roomDomain=strtolower((string)($domain['roomDomain']??''));if($roomDomain==='sprinkler')return new RenderBewaesserung();return new RenderGeraete();}
